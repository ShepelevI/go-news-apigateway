...
// Возвращаем новость по ее ID и ошибку.
...
// Ищем статьи по регулярному выражению и возвращаем массив из них,
// число страниц, текущую страницу и ошибку. Текущую страницу принимаем как аргумент.
// Если для нее нет постов, то возвращаем для 1й страницы.
func (db *DB) GetNewsByRegExp(regExp string, currentPage int) (
	...
	// Вернем результаты для 1й страницы, если на запрашиваемой ничего нет.
