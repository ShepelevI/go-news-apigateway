...
func getNewsTreeDetailed(w http.ResponseWriter, r *http.Request) {
	...
	go func() {
		...
		reqComments, err := http.NewRequest(http.MethodGet, commentTreeURL, jsonComments)
		if err != nil {
			panic(err)
		}
		...
		commentsResponse := CommentsTreeByIDResponse{}
